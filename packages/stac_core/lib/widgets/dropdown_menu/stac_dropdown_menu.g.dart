...
StacDropdownMenu _$StacDropdownMenuFromJson(
  ...
  selectedTrailingIcon:
      json['selectedTrailingIcon'] == null
          ? null
          : StacWidget.fromJson(
  ...
  inputFormatters:
      (json['inputFormatters'] as List<dynamic>?)
          ...
          .toList(),
  alignmentOffset:
      json['alignmentOffset'] == null
          ? null
          : StacOffset.fromJson(
            json['alignmentOffset'] as Map<String, dynamic>,
          ),
  expandedInsets:
      json['expandedInsets'] == null
          ? null
  ...
  dropdownMenuEntries:
      (json['dropdownMenuEntries'] as List<dynamic>?)
          ?.map(
            (e) => StacDropdownMenuEntry.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
...
Map<String, dynamic> _$StacDropdownMenuToJson(
  ...
  'dropdownMenuEntries':
      instance.dropdownMenuEntries?.map((e) => e.toJson()).toList(),
  'closeBehavior':
