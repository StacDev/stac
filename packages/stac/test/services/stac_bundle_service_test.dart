...
class _FakeHttpClientAdapter implements HttpClientAdapter {
  ResponseBody Function(RequestOptions options) handler = (options) {
...
void main() {
  ...
  group('seed hydration', () {
    ...
    test('newer seed wins over an older stored bundle and is persisted', () async {
      await const SharedPreferencesBundleStore().write(
  ...
  group('StacBundleUpdater', () {
    ...
    test('polling interval triggers conditional syncs and pause cancels them', () async {
      await const SharedPreferencesBundleStore().write(storedBundle());
      adapter.handler = (options) => statusResponse(304);
      await initStac(
        bundleConfig: const StacBundleConfig(
