    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          final animeData =
              snapshot.data?.data['data']['Page']['airingSchedules'] as List;
              ...
              child: Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.network(
                      widget.airSchedule[position]['media']['bannerImage'] ??
                          widget
                              .airSchedule[position]['media']['coverImage']['extraLarge'],
                      fit: BoxFit.cover,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget
                                  .airSchedule[position]['media']['title']['romaji'],
            ...
            onTap:
                () => {
                  StacRegistry.instance.setValue(
                    "anime_id",
                    widget.airSchedule[position]['media']['id'].toString(),
                  ),
