...
|--------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| columnWidths             | `Map<int, StacTableColumnWidth>`   | Determines the column width on a column by column basis, if a particular column entry has null width `defaultColumnWidth` is used. See [`StacTableColumnWidth`](/styles/table_column_width) |
| defaultColumnWidth       | `StacTableColumnWidth`             | Determines the  default column width. Defaults to `flexColumnWidth`. See [`StacTableColumnWidth`](/styles/table_column_width)                                                               |
...
| border                   | `StacTableBorder`                  | Defines the border style for `StacTable`. See [`StacTableBorder`](/styles/table_border).                                                                                                   |
