...
| ifTrue    | `Map<String, dynamic>` | **Required.** The widget to render when condition evaluates to true.        |
| ifFalse   | `Map<String, dynamic>?`| The widget to render when condition evaluates to false. Renders empty if null. |
