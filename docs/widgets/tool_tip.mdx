...
Tooltips provide text labels that help explain the function of a button or UI element.  

To learn more about Flutter’s Tooltip widget, refer to the  
[official Flutter documentation](https://api.flutter.dev/flutter/material/Tooltip-class.html).
