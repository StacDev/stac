---
title: "Migration Guide: JSON to Dart DSL"
description: "Step-by-step guide to migrate from JSON to Stac Dart DSL"
---

This guide helps you migrate existing Stac JSON configurations to the new Dart DSL format. The Dart DSL provides type safety, IDE autocompletion, and a more natural development experience.

## Why Migrate to Dart DSL?

| Feature | JSON | Dart DSL |
|---------|------|----------|
| Type Safety | No | Yes |
...
After migrating, build your Dart DSL to JSON:
