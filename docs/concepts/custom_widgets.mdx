...
3. **Parser**: A corresponding parser to render your widget (see [Custom Parsers](/concepts/parsers))
...
To render your widget, create a parser (see [Custom Parsers](/concepts/parsers) for details):
