...
BorderSide is used with the new individual border sides feature in [StacBorder](/styles/border). You can now specify different border sides for top, right, bottom, and left individually.
...
- [Border](/styles/border) - Learn about using individual border sides in StacBorder
