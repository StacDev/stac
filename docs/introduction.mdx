...
<Columns cols={2}>
  ...
  href="/quickstart"
  >
    Step-by-step guide to help your get started with Stac and learn the core features.
  </Card>
      <Card
    title="Stac CLI"
...
Ready to build your first server-driven UI app? [Get started now →](/get_started)