...
class PreviewPanel {
    ...
    constructor(extensionUri, hostUrl, hostPort) {
        ...
        this.panel = vscode.window.createWebviewPanel('stacPreview', 'Stac Preview', { viewColumn: vscode.ViewColumn.Beside, preserveFocus: true }, {
            enableScripts: true,
    ...
    postThemes(themes, selectedThemeName) {
        return this.panel.webview.postMessage({
